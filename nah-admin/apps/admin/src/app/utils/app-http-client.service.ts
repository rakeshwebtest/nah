...
export class AppHttpClient {
    ...
    public constructor(public http: HttpClient, public appConfigService: AppConfigService,
    ...
    public get<T>(endPoint: string, options?: IRequestOptions): Observable<any> {
        if (this.appConfigService.settings.apiUrl) {
            this.api = this.appConfigService.settings.apiUrl;
        }
...
export function AppHttpClientCreator(http: HttpClient, appConfigService: AppConfigService, injector: Injector) {
    return new AppHttpClient(http, appConfigService, injector);
}
